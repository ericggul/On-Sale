...
func generateSentence(product: Product) -> [Script]{
    ...
    return(
        ...
        Script(sentence: "\(product.name),  \(product.origin)에서 가져온 \(product.name) 세일입니다", type: sentenceType.i, isSelected: true, isShown: false),
        ...
        Script(sentence: "둘이 먹다가 하나 죽어도 모르는 이맛. \(product.origin)산 \(product.name)입니다.", type: sentenceType.f,isSelected: true, isShown: false),
        Script(sentence: "집에가서 드세요. \(product.discountPrice)원.", type: sentenceType.f,isSelected: true, isShown: false),
        Script(sentence: "집가서 잡수세요.", type: sentenceType.f,isSelected: true, isShown: false),
        Script(sentence: "싸다 싸. 세일입니다. \(product.discountPrice)원", type: sentenceType.f,isSelected: true, isShown: false),
        ...
        Script(sentence: "다 먹고 살자고 하는일 아니겠습니까.", type: sentenceType.f,isSelected: true, isShown: false),
            Script(sentence: "이거 하나 팔아주면, 누이 좋고, 매부 좋은거에요. 한번 집에가서 잡수세요. \(product.origin)산 \(product.name), 세일입니다.", type: sentenceType.f,isSelected: true, isShown: false),
        Script(sentence: "이거 먹을려고 다음 생에는 인간으로 태어날려고요. \(product.origin)에서 온 \(product.name)입니다.", type: sentenceType.f,isSelected: true, isShown: false),
        Script(sentence: "후, 저도 한번 먹고 싶네요. \(product.name),\(product.origin)에서 왔습니다. ", type: sentenceType.f,isSelected: true, isShown: false),
